...
**Notes**:
 ...
 - `dsOmics` depends on the `resourcer` package that can be installed by (this is needed only when debugging with `DSLite`, in a standard DataSHIELD operation these packages are installed on the R server side):

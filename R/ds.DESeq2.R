...
#' @description This function is similar to Bioconductor's
...
#' @param set a \code{RangedSummarizedExperiment} 
...
{   
    ...
    calltext <- call("DESeq2DS",vars, set, test, fitType, sfType, betaPrior, reduced, contrast)
